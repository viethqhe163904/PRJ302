<%-- 
    Document   : crud_produc.jsp
    Created on : Mar 7, 2023, 9:25:53 PM
    Author     : manh3
--%>
        ...
        <script type="text/javascript">
            function deleteProduct(id) {
                if (confirm("Are you sure to delete  this Product ? ")) {
                    window.location = "crud?did=" + id;
                }
            }
        </script>
        <script type="text/javascript">
            function updateProduct(id) {
                window.location = "crud?uid=" + id;
            }
        </script>
        <meta charset="utf-8">
                    ...
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a href="home" class="btn btn-danger"     ><i class="material-icons house">&#xea44;</i> <span>Home</span></a>						
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <c:forEach items="${requestScope.list}" var="p" varStatus="status">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="update?uid=${p.id}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a href="crud?did=${p.id}" onclick="deleteProduct('${p.id}')" class="delete" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            <!-- Delete Modal HTML -->
