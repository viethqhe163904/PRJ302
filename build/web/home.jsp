                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="shop">
                            ...
                            <div class="shop-body">
                                <h4>${c.name}</h4>
                                <a href="store?id=${c.id}" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    </c:forEach>
                        ...
                        <div class="shop">
                            ...
                            <div class="shop-body">
                               <h4>View all Product</h4>
                                <a href="store?id=${6}" class="cta-btn">Shop now<i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- /shop -->
                            ...
                            <div class="products-tabs">
                                ...
                                <div id="tab1" class="tab-pane active">
                                    <div class="products-slick" data-nav="#slick-nav-1">
                                        <!-- product -->
                                        <c:forEach items="${requestScope.list_n}" var="n">
                                        <div class="product">
