<%-- 
    Document   : update
    Created on : Mar 11, 2023, 5:00:01 PM
    Author     : manh3
--%>
        ...
        <div class="section">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <c:if test="${requestScope.c==null && requestScope.b==null}">
                                    <h2 style="color: white">Update <b>Product</b></h2>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <h2 style="color: white">Update <b>Category</b></h2>
                                </div>
                                <div class="col-sm-6">
                                    <a href="crud_category" class="btn btn-success"><i class="fa fa-chevron-left"></i> <span>Back To Manage Category</span></a>
                                    </c:if>
                                     <c:if test="${requestScope.b!=null}">
                                    <h2 style="color: white">Update <b>Brand</b></h2>
                                </div>
                                <div class="col-sm-6">
                                    <a href="crud_category" class="btn btn-success"><i class="fa fa-chevron-left"></i> <span>Back To Manage Brand</span></a>
                                    </c:if>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id">
                                        <c:forEach items="${requestScope.category}" var="c">
                                            <option ${(pid.brand.getId() == c.id)?"selected":""} value="${c.id}">${c.name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="brand_id">
                                        <c:forEach items="${requestScope.brands}" var="b">
                                            <option ${(pid.brand.id == b.id)?"selected":""} value="${b.id}">${b.name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class="form-group">
                ...
                <c:if test="${requestScope.c!=null}">
                    <div id="editEmployeeModal" >
                        <div class="modal-content">
                            <c:set value="${requestScope.c}" var="pid"/>
                            <form action="update" method="post">
                                <div class="modal-header">						
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label>Name</label>
                                        <textarea name="title" class="form-control" required>${pid.name}</textarea>
                                    </div>
                    ...
                    <div id="editEmployeeModal" >
                        <div class="modal-content">
                            <c:set value="${requestScope.b}" var="pid"/>
                            <form action="update" method="post">
                                <div class="modal-header">						
