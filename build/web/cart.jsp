<%-- 
    Document   : card
    Created on : Mar 10, 2023, 8:24:13 PM
    Author     : manh3
--%>
                    ...
                    <main class="col-md-9">
                        <div class="card">
                                        ...
                                        <tr>
                                            <td>
                                                <figure class="itemside">
                                                    <div class="aside"><img src="${i.product.image}" width="250" height="190" class="img-sm">
                                                    </div>
                                                    <figcaption class="info">
                                                        <a href="#" class="title text-dark">${i.product.title}</a>
                                                        <p class="text-muted small">Brand: ${i.product.brand.name}
                                                    </figcaption>
                                                </figure>
                                            </td>
                                            <td class="quantity">
                            ...
                            <div class="card-body border-top">
                                ...
                                <a href="store?id=6" class="btn btn-light"> <i class="fa fa-chevron-left"></i> Continue shopping </a>
                            </div>
                        </div> <!-- card.// -->
                    </main> <!-- col.// -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-center mb-3">
                                    <img  height="100px" src="./images/pay.png" height="40">
                                </p>
